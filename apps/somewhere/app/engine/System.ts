...
// export type SystemEntityQueries<U extends Record<string, EntityQuery> | undefined = undefined> =
//   U extends Record<string, EntityQuery> ? U : null;
...
> {
  ...
  readonly entityQueries: U; // entity queries are for querying entitties that this system will only read, not modify
